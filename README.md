...
With Pixar's USD system emerging as a powerful agent for 3D graphics pipelines and interchange. This addon uses AMD Radeon™ ProRender renderer in USD Hydra rendering system in Blender.
...
On the [releases](https://github.com/GPGPU-Desigh-Agents/BlenderUSDHydraAddon/releases) page are prebuilt versions of the ready to install addon. 

## Installing Add-on

Download the add-on from the releases page [releases](https://github.com/GPGPU-Desigh-Agents/BlenderUSDHydraAddon/releases). Open Blender preferences and got to the Add-ons section click Install button and pick the add-on in File Browser. Enable the add-on from the Add-ons section.
...
- `deps/RadeonProRenderUSD` https://github.com/GPGPU-Desigh-Agents/RadeonProRenderUSD
...
```commandline
> git clone https://github.com/GPGPU-Desigh-Agents/BlenderUSDHydraAddon
